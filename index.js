...
function lakukanLooping(arrPegawai) {
  ...
  */
  let jumlahPria = 0;
  for (let gender = 0; gender < dataYangAkanDilooping.length; gender++) {
    if (dataYangAkanDilooping[gender].jenisKelamin === 'M') jumlahPria++;
  }
  /*
  ...
  */
  let jumlahWanita = 0;
  for (let gender = 0; gender < dataYangAkanDilooping.length; gender++) {
    if (dataYangAkanDilooping[gender].jenisKelamin === 'F') jumlahWanita++;
  }
  /*
  ...
  */
  ...
  else if (jumlahPria < jumlahWanita) komentar = "Jumlah Wanita lebih banyak dari Pria";
